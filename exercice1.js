const countries = [
 ...
 let myArray1 = [];
 let total1 = myArray1.length;
console.log(total1);

/*Declare an array with more than 5 number of elements
 Find the length of your array*/
    let myArray = [99, 101.5, 5, 6, 44];
...
console.log(arr1.splice(arr1.length));
...
let ITcompanies = 'Facebook, Google, Microsoft, Apple, IBM, Oracle, Amazon'
const companies = ITcompanies.split(',')
...
let indexOftiktok = itCompanies.indexOf('tiktok') 
if(indexOftiktok === -1){
...
for(let i= 0; i < itCompanies.length; i++){
 let  k= itCompanies[i].match(/o.{2}/g);
    if (k)  {
